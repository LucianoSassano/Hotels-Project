...
public class ErrorMessage {
    ...
    public static final String BEDDING_NOT_FOUND = "There wasn't any bedding according to the request";
    ...
    public static final String RESERVATION_NOT_FOUND = "There wasn't any reservation according to the request";
    ...
    public static final String NOT_POSITIVE = "Field must be a positive number";
